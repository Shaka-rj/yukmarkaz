GROUPS = [
    -1001277508775, #"@qarshi1yukmarkazi", 
    -1001265203537, #"@Gmail058omad", Кукон ISUZU ва KIA юк ташиш хизмати
    -1001277508775, #"@yukmarkazikia", Vodiy Toshkent yuk markazi
    -1001559688405, #"@kiaxundayyukgroup",
    -1001224987633, #"@Qarshi_yuk_Gazel_Isuzi_Kamaz", QARSHI YUK MARKAZI MEGA GRUPPASI
    -1001753572530, #"@qarshi1yukmarkazi" QASHQADARYO🇺🇿 YUK MARKAZI
    -1002087957389, #"@Toshkent_labo_yuk",
    -1002143730442, #"@yittom",
    -1001830913396, #"@kiya_labo_yuk_markazi_dostafka",
    -1001952655029, #"@toshkentsamarqandlabo",
    -1003003217964, #"@Changan_labo_sheniray_yuktashish",
    -1002456350542, #"@kia_hunday_yuk_tashish",
    -1002013232154, #"@changan_chatt",
    -1001459136568, #"@CHANGAN_LABO",
    -1001817527891, #"@yuk41",
    -1001700205174, #"@QARSHILABOXIZMATI",
    -1002407356179,
    "@furachilar_yukmarkazi_isuzu",
